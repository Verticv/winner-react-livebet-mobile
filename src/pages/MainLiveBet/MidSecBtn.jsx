    ...
    <div className={`bet-button-container ${rightActiveBackground ? 'first-section-red' : ''}`}>
      <div className='bet-btn-container'>
        <div className='bet-btn-skew' onClick={() => {
          ...
          <button className={`add-button ${isFirstItemRed ? 'red-button' : ''}`} style={{transform: !isFirstItemRed ? 'translateY(0.3rem)' : ''}}  type='button' onClick={add}>
        ...
        <div className={`bet-btn-skew ${leftActiveBackground ? 'blue-section' : ''}`} onClick={() => {
          ...
          <button className={`add-button ${isFirstItemRed ? 'blue-button' : ''}`} style={{transform:!isFirstItemRed ? 'translateY(0.3rem)' : ''}}  type='button' onClick={add}>
