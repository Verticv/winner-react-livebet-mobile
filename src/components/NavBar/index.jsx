...
function NavBar({ isActive }) {
  return (
    <div className='nav'>
      ...
      <NavButtons icon={basketBallWhite} clickedIcon={basketBallBlack} text='전체' number={number} link='/' />
      <NavButtons icon={footBallWhite} clickedIcon={footBallBlack} text='축구' number={number} link='/mainLiveList' />
      <NavButtons icon={ballWhite} clickedIcon={ballBlack} text='야구' number={number} link='/mainNonLiveList' />
      <NavButtons icon={valBallWhite} clickedIcon={valBallBlack} text='농구' number={number} link='/basketball' />
      <NavButtons icon={ballyWhite} clickedIcon={ballyBlack} text='배구' number={number} link='/volleyball' />
    </div>
  );
}
