        ...
        <footer className='flex'>
          ...
          <div className='sub-container2'>
            <p style={{ letterSpacing: isIOS ? '-0.2rem' : '' }}>
              선택경기
              <span style={{ display: 'inline-block', width: '7.4rem', textAlign: 'center' }}>3<span className='noto-sans'>건</span></span>
            </p>
            <p className='sub-p' style={{ letterSpacing: isIOS ? '-0.2rem' : '' }}>예상배당<span style={{ marginLeft: '0.1rem', display: 'inline-block', width: '6.3rem', textAlign: 'end' }}>4.25</span>
            </p>
          </div>
        </footer>
